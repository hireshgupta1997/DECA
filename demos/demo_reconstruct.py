...
def main(args):
    ...
    # load test images 
    testdata = datasets.TestData(args.inputpath, iscrop=args.iscrop, face_detector=args.detector, sample_step=args.sample_step)  # face-detector = 'fan'; args.iscrop=True should be false
